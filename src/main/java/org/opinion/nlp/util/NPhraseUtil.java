...
public class NPhraseUtil {

	public static HashSet negationWords = new HashSet();
	public static HashSet stopWords = new HashSet();
	public static HashSet stopWordsVerb = new HashSet();

	public static HashSet addNegationTerms(){
	...
	public static HashSet addStopWordsVerb(){
		stopWordsVerb.add("be");
		stopWordsVerb.add("be with");
		stopWordsVerb.add("in");
		stopWordsVerb.add("be in");
		stopWordsVerb.add("that");
		stopWordsVerb.add("on");
		stopWordsVerb.add("w in");
		stopWordsVerb.add("be on");
		stopWordsVerb.add("be one");
		stopWordsVerb.add("be of");
		return stopWordsVerb;
	}
	...
	public static HashSet addStopWords(){
		...
		stopWords.add("permission");
		stopWords.add("research");
		stopWords.add("work");
		stopWords.add("author");
		stopWords.add("appendix");
