...
public class SentimentExtractor {
	...
	public static String path = "/home/firzhan/operation-infinity/home/swn/www/admin/dump" +
			"/SentiWordNet_3.0.0_20130122.txt";

	private static Map<String, Double> dictionary;

	public SentimentExtractor() throws IOException {
...
*/
	public double extract(String word, String pos) {
		try {
			...
			System.out.println("No Sentiment found for the word:" + word + " pos:" + pos);
			return 0.0;
		}
	}
